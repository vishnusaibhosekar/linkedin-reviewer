...
import { Loader2Icon, LogOut, User, Download, FileText, TrendingUp, Clock, CheckCircle2, Play, Shield, Plus, User2, ChevronDown } from "lucide-react";
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
                    <div className="flex items-center justify-between gap-3 sm:gap-4">
                        ...
                        <div className="relative" ref={menuRef}>
                            ...
                            >
                                {(!avatarError && (user.profile?.avatar_url || user.avatar_url)) ? (
                                    <img
                                ...
                                <div className="text-left hidden sm:block">
                                    <p className="text-sm font-medium text-gray-900 leading-tight">{user.profile?.name || user.name}</p>
                            ...
                            {showUserMenu && (
                                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                                    ...
                                    <div className="px-4 py-3 border-b border-gray-100 sm:hidden">
                                        <p className="text-sm font-medium text-gray-900">{user.profile?.name || user.name}</p>
